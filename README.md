...
```bash
git clone https://github.com/Enjoying-Dev/portfolio.git my-portfolio
cd my-portfolio
npm install
npm run dev
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Enjoying-Dev/portfolio)

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/Enjoying-Dev/portfolio)
...
```bash
git clone https://github.com/Enjoying-Dev/portfolio.git
cd portfolio
```
...
**Mark Yamato**
- GitHub: [@Enjoying-Dev](https://github.com/Enjoying-Dev)
- LinkedIn: [mark-yamato](https://linkedin.com/in/mark-yamato/)
- Email: mrmarkg101@gmail.com

## 🤝 Contributing

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Enjoying-Dev/portfolio/issues).
